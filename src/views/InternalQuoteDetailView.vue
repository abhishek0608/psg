  ...
  <section class="ect-min-h-screen ect-bg-[#f6efec] ect-pt-32 ect-pb-16">
    <div class="ect-max-w-6xl ect-mx-auto ect-px-5">
      ...
      <header class="ect-bg-white ect-border ect-border-rose-200/50 ect-rounded-lg ect-p-5 ect-mb-6">
        ...
        <p class="ect-font-body ect-text-micro ect-uppercase ect-tracking-eyebrow ect-text-rose-600 ect-mb-2">Quote record</p>
      ...
      <section v-if="quote" class="ect-grid lg:ect-grid-cols-[minmax(0,0.85fr)_minmax(0,1.15fr)] ect-gap-5">
        <article class="ect-bg-white ect-border ect-border-rose-200/50 ect-rounded-lg ect-p-5">
          <p class="ect-font-body ect-text-micro ect-uppercase ect-tracking-label ect-text-charcoal/40 ect-mb-3">Quote</p>
          <dl class="ect-space-y-4">
            <div>
              <dt class="ect-font-body ect-text-xs ect-uppercase ect-tracking-label ect-text-charcoal/35">Quote No</dt>
          ...
          <div class="ect-mt-6 ect-pt-5 ect-border-t ect-border-rose-100">
            <p class="ect-font-body ect-text-micro ect-uppercase ect-tracking-label ect-text-charcoal/40 ect-mb-3">Shipping address</p>
              ...
              >
                ...
                >
                  <template v-for="(value, key) in item.customization" :key="key">
                    <dt v-if="value" class="ect-font-body ect-text-micro ect-uppercase ect-tracking-label ect-text-charcoal/40">{{ key }}</dt>
